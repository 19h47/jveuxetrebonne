...
/**
 * Class JVeuxEtreBonne.
 */
class JVeuxEtreBonne extends TimberSite {
	 ...
	 * Add to Twig
	 *
	 * @param obj $twig The Twig object.
	 */
	 ...
	 * Add to context
	 *
	 * @param arr $context The array context.
	 * @return $context
	 * @access  public
	 */
 ...
 */
$theme = new JVeuxEtreBonne( 'jveb', '1.0.0' );
